            ...
            <div className="col-12 col-lg-6">
              <div className="row justify-content-xl-center">
                <div className="col-12 col-xl-11">
                  ...
                  <p className="lead fs-4 text-secondary mb-5">เรามองหาโอกาสที่จะทำงานร่วมกับลูกค้าใหม่ๆ อยู่เสมอ หากคุณสนใจร่วมงานกับเรา โปรดติดต่อด้วยวิธีใดวิธีหนึ่งต่อไปนี้</p>
                  <div className="d-flex mb-5">
                    ...
                    <div>
                      ...
                      <address className="mb-0 text-secondary">1315 Soi Latphrao 94 Latphrao Road</address>
                    </div>
                  </div>
                    ...
                    <div className="col-12 col-sm-6">
                      <div className="d-flex mb-0">
                        ...
                        <div>
                          ...
                          <p className="mb-0">
                            <a className="link-secondary text-decoration-none" href="mailto:contact@bootbrains.com">EIEISOFT@hotmail.com</a>
                          </p>
                        </div>
                      </div>
                    </div>
